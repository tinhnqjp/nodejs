(function () {
  ...
  describe('Admin Laws List Controller Tests', function () {
    // Initialize global variables
    var LawsAdminListController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _LawsService_) {
      ...
      $httpBackend.whenGET('/modules/laws/client/views/list-laws.client.view.html').respond(200, '');
      ...
      LawsAdminListController = $controller('LawsAdminListController as vm', {
        $scope: $scope
      });
